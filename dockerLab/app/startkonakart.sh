...
agentstring="=name=${HOSTNAME},server=konakart_collector:9998"
PRG="$0"
...
export CATALINA_OPTS="${CATALINA_OPTS} -agentpath:/opt/dynatrace-6.3/agent/lib64/libdtagent.so${agentstring}"
echo ${CATALINA_OPTS}
